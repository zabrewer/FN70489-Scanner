...
Based upon all of these criteria, this host would be a good candidate to upgrade *although* it does not seem to have other services or lines referencing the self-signed certificate ( > 4)
